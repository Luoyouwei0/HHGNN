...
class Data:
    def __init__(self, data_dir='./DBLP/JF17K/'):
        print('Loading the string facts from raw DBLP...')
        ...
        print('Loading DBLP finished!')

    def load_strfacts(self, data_dir='./DBLP/JF17K/'):
...
if __name__ == '__main__':
    data = Data(data_dir="./DBLP/FB-AUTO/")
